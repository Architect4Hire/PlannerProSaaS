        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentPeriodEndsAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SurfaceColor = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: true),
                    LoginTagline = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Role = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    DefaultCapacityPoints = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SprintLengthDays = table.Column<int>(type: "int", nullable: false),
                    OverloadThresholdPoints = table.Column<int>(type: "int", nullable: false),
